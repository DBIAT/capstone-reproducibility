...
optimism scores. -->
<!-- I could do this two ways.  Either the way I presented it below or, alternately, I could forego the summary and use the min(politics$omtimismscore[politics$testtime=="post"]) and mean(politics$optimismscore[politics$testtime=="post"]) as well as the var(politics$optimismscore[politics$testtime=="post"]).  I simply thought I'd kill two birds with one stone and use two commands instead of three.-->

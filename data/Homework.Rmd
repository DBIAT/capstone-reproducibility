...
-->
<!-- Since I want to take into account your preferences, as you mentioned in the Example, I also utilized the below commands. -->
...
optimism scores. -->
<!-- I could do this two ways.  Either the way I presented it below or, alternately, I could forego the summary and use the min(pols$omtimismscore[pols$testtime=="post"]) and mean(pols$optimismscore[pols$testtime=="post"]) as well as the var(pols$optimismscore[pols$testtime=="post"]).  I simply thought I'd kill two birds with one stone and use two commands instead of three.-->
...
<!-- Again, there are two ways to do this.  Either the way I do it below or using testtime=="post".  Either will get you the answer.
-->

...
```
At R2=0.90, F(3, 62)=180.3, p<.001, we can conclude that pretest optimism scores predict posttest optimism scores with a tight slope of 0.94, almost a one-for-one correlation.  
